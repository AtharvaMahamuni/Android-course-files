...
//    val tip = calculateTip(amount)
    ...
    var tipPercent = tipPercentInput.toDoubleOrNull() ?: 0.0
...
@Composable
fun EditNumberField(value: String, onValueChange: (String) -> Unit, label : String, @DrawableRes leadingIcon: Int, imeAction: ImeAction, modifier: Modifier = Modifier) {
    TextField(
        value = value,
        label = { Text(label) },
        leadingIcon = { Icon(painter = painterResource(id = leadingIcon), "Icon") },
        singleLine = true,
